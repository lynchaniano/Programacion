...
//Por ejemplo para un número N = 12345   La salida debe ser en piramide:1, 12, 123 ,1234 ,12345
public class BasicoES11
{
	...
	{
		System.out.println("  -- BasicoES11 --");
		BasicoES11 bes = new BasicoES11();
		bes.cargarDato();
	}
